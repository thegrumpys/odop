import { MAX, FIXED, CONSTRAINED } from '../actionTypes.js';
import { saveInputSymbolValues, restoreInputSymbolValues, changeResultTerminationCondition } from '../actions.js';
import { search } from './search.js';
import { despak } from './despak.js';
...
//    console.log('In seek SOUGHT=',SOUGHT,'SDIR=',SDIR,'temp=',temp,'M_NUM=',M_NUM,'M-DEN=',M_DEN);
    ...
    ncode = 'Seek completed. ' + name + ' ' + (starting_value) + ' --> ' + (ending_value) + ' ' + units + '; ' + (percent_improvement) + '% improvement.';
