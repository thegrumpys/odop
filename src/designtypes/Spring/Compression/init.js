...
import * as mo from '../mat_offsets.js';
import m_tab_us from '../mat_us.json' with { type: "json" };
import m_tab_metric  from '../mat_metric.json' with { type: "json" };
import * as eto from './endtypes_offsets.js';
import et_tab from './endtypes.json' with { type: "json" };
import { changeSymbolInput, changeSymbolHidden } from '../../../store/actions.js';
...
// console.log('In init store=',store,'p=',p,'x=',x);
 ...
 if (x[o.Material_File] === "mat_metric.json") m_tab = m_tab_metric;
    else m_tab = m_tab_us;
