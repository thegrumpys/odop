...
//            console.log('TEST: Before INSERT name1=', name1,' type1=', type1,' value1=', value1);
            var stmt1 = 'INSERT INTO design (name, type, value) VALUES (\''+name1+'\',\''+type1+'\',\''+value1+'\')';
...
//                console.log('TEST: Before INSERT name2=', name2,' type2=', type2,' value2=', value2);
                var stmt2 = 'INSERT INTO design (name, type, value) VALUES (\''+name2+'\',\''+type2+'\',\''+value2+'\')';
...
//                    console.log('TEST: Before INSERT name3=', name3,' type3=', type3,' value3=', value3);
                    var stmt3 = 'INSERT INTO design (name, type, value) VALUES (\''+name3+'\',\''+type3+'\',\''+value3+'\')';
