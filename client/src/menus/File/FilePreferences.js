                                        ...
                                        <Row key={property_name}>
                                            ...
                                            <Col className="align-middle text-right">
                                                <Form.Control type="number" className={
                                                        'text-right ' + (isNaN(parseFloat(this.state.system_controls[property_name])) ? 'borders-invalid ' : '')
                                                    } value={this.state.system_controls[property_name]} onChange={(event) => {this.onChange(property_name, event.target.value)}} onBlur={(event) => {this.onBlur(property_name, event.target.value)}}/>
                                            </Col>
                                        </Row>
                                    );
                                })
