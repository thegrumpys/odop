...
class FilePreferences extends Component {
    ...
    onRestoreDefaults() {
        ...
        window.gtag('event', 'FilePreferences', { 'event_category': 'menu', 'event_label': 'RestoreDefaults' });
    }
    ...
    onApplyandClose() {
        ...
        window.gtag('event', 'FilePreferences', { 'event_category': 'menu', 'event_label': 'ApplyandClose' });
