...
//    console.log('In search ncode=',ncode);
    ...
    ncode = ncode + ' Wire_Dia set to Non-Standard Size';
...
//        console.log('In 2','p_2=',p_2,'ncode_2=',ncode_2);
        shadow_store.dispatch(enableDispatcher(true));
        shadow_store.dispatch(changeInputSymbolValues(p_2, merit)); // Inject 2 search's p into shadow_store
...
//        console.log('In 2','shadow_store_state_2.model.result.objective_value=',shadow_store_state_2.model.result.objective_value);
        if (shadow_store_state_2.model.result.objective_value <= shadow_store_state_2.model.system_controls.objmin) {
          p = [...p_2];
...
//        console.log('In 3','p_3=',p_3,'ncode_3=',ncode_3);
        shadow_store.dispatch(enableDispatcher(true));
        shadow_store.dispatch(changeInputSymbolValues(p_3, merit)); // Inject 2 search's p into shadow_store
...
//        console.log('In 3','shadow_store_state_3.model.result.objective_value=',shadow_store_state_3.model.result.objective_value);
        if (shadow_store_state_3.model.result.objective_value <= shadow_store_state_3.model.system_controls.objmin) {
          p = [...p_3];
