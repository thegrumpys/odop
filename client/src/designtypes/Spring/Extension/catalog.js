...
//        console.log('In getCatalogEntries 3 objective_value=',objective_value);
        ...
        if (!Number.isFinite(objective_value)) {
          ...
          include_entry = false;
          if (cat0 === undefined || objective_value < cat0[10]) { cat3 = cat2; cat2 = cat1; cat1 = cat0; cat0 = entry; }
          else if (cat1 === undefined || objective_value < cat1[10]) { cat3 = cat2; cat2 = cat1; cat1 = entry; }
          else if (cat2 === undefined || objective_value < cat2[10]) { cat3 = cat2; cat2 = entry; }
          else if (cat3 === undefined || objective_value < cat3[10]) { cat3 = entry; }
