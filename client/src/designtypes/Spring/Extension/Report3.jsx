    ...
    <>
      ...
      <table id="view2" className="report-table">
        <tbody>
          ...
          <tr>
            ...
            <td />
            <td>{model_symbol_table[o.End_Extension].name}</td>
            <td>=</td>
            <td>{model_symbol_table[o.End_Extension].value.toFixed(3)}</td>
            <td className="text-start">{model_symbol_table[o.End_Extension].units}</td>
          </tr>
          <tr>
            <td>{base.len_lbl}</td>
            <td>=</td>
      ...
      <table id="view3" className="report-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{(100.0 * model_symbol_table[o.Stress_Initial].value / model_symbol_table[o.Tensile].value).toFixed(1)}</td>
      ...
      <table id="view4" className="report-table">
        <tbody>
          ...
          <tr>
            <td className="text-start">{model_labels[o.Relative_loop_pos____tol_].name}: </td>
            <td />
            <td className="text-start" colSpan="4">{model_labels[o.Relative_loop_pos____tol_].value}</td>
          </tr>
          <tr>
            <td className="text-start">{model_labels[o.Gaps].name}: </td>
            <td />
            <td className="text-start">{model_labels[o.Gaps].value}</td>
            <td className="text-start">{model_symbol_table[o.Wire_Dia].units}</td>
            <td />
          </tr>
          <tr>
