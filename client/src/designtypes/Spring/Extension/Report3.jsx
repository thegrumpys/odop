        ...
        return (
            <>
                <h4 className="d-flex mt-3">
                    <span className="ms-auto">ODOP:Spring &nbsp; Extension Spring Report &nbsp; &nbsp; <a href="https://www.springdesignsoftware.org"><small>https://www.springdesignsoftware.org</small></a></span>
                ...
                <table id="view1" className="report-table">
                    <tbody>
                        <tr>
                            ...
                            <td/>
                            <td className="text-start" width="30%">{this.props.labels[o.Contact_person].value}</td>
                            <td/>
                            <td>{this.props.labels[o.Phone___email].name}: </td>
                            <td/>
                            <td className="text-start" width="30%">{this.props.labels[o.Phone___email].value}</td>
                        </tr>
                        <tr>
                            <td>{this.props.labels[o.Company_name].name}: </td>
                            <td/>
                            <td className="text-start" width="30%">{this.props.labels[o.Company_name].value}</td>
                            <td/>
                            <td>{this.props.labels[o.Date].name}: </td>
                            <td/>
                            <td className="text-start" width="30%">{this.props.labels[o.Date].value}</td>
                        </tr>
                        <tr>
                            <td>{this.props.labels[o.Street].name}: </td>
                            <td/>
                            <td className="text-start" width="30%">{this.props.labels[o.Street].value}</td>
                            <td/>
                            <td>{this.props.labels[o.Part_Number].name}: </td>
                            <td/>
                            <td className="text-start" width="30%">{this.props.labels[o.Part_Number].value}</td>
                        </tr>
                        <tr>
                            <td>{this.props.labels[o.City__State___Zip].name}: </td>
                            <td/>
                            <td  className="text-start" width="30%">{this.props.labels[o.City__State___Zip].value}</td>
                            <td/>
                            <td/>
                            <td/>
                            <td/>
                ...
                <table id="view2" className="report-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="text-start">{this.props.symbol_table[o.End_Extension].units}</td>
                        </tr>
                        <tr>
                            <td>{this.len_lbl}</td>
                            <td>=</td>
                            <td>{this.wire_len_t.toFixed(3)}</td>
                            <td className="text-start">{this.props.symbol_table[o.L_Free].units}</td>
                            <td/>
                ...
                <table id="view3" className="report-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="text-start" colSpan="2">{this.props.symbol_table[o.Force_1].units}</td>
                        </tr>
                        <tr>
                            ...
                            <td>{this.safe_travel.toFixed(3)}</td>
                            <td className="text-start">{this.props.symbol_table[o.Deflect_2].units}</td>
                        </tr>
                        <tr>
                            <td><b>Length</b></td>
                        ...
                        <tr>
                            ...
                            <td className="text-start">{this.props.symbol_table[o.OD_Free].units}</td>
                        </tr>
                        <tr>
                            ...
                            <td className="text-start">{this.props.symbol_table[o.ID_Free].units}</td>
                        </tr>
                        <tr>
                            <td><b>Energy</b></td>
                            <td>{(0.0).toFixed(2)}</td>
                            ...
                            <td className="text-start">{this.props.symbol_table[o.Energy].units}</td>
                        </tr>
                        <tr>
                            ...
                            <td className="text-start">{this.props.symbol_table[o.Stress_1].units}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>{(1.0).toFixed(2)}</td>
                            <td className="text-start">{this.props.symbol_table[o.FS_2].units}</td>
                        </tr>
                        <tr>
                            <td/>
                            <td className="text-start" colSpan="2"><sup>*</sup> kw = {this.kw1.toFixed(3)}</td>
                        </tr>
                    </tbody>
                </table>
                <hr/>
                ...
                <table id="view4" className="report-table">
                    <tbody>
                        <tr>
                            <td className="text-start">{this.props.labels[o.Data_Source].name}: </td>
                            <td/>
                            <td className="text-start" colSpan="4">{this.props.labels[o.Data_Source].value}</td>
                        </tr>
                        <tr>
                            <td className="text-start">{this.props.labels[o.Mandril].name}: </td>
                            <td/>
                            <td className="text-start">{this.props.labels[o.Mandril].value}</td>
                            <td className="text-start">{this.props.symbol_table[o.ID_Free].units}</td>
                            <td colSpan="2"></td>
                        </tr>
                        <tr>
                            <td className="text-start">{this.props.labels[o.Wind].name}: </td>
                            <td/>
                            <td className="text-start" colSpan="2">{this.props.labels[o.Wind].value}</td>
                        </tr>
                        <tr>
                            <td className="text-start">{this.props.labels[o.Relative_loop_pos____tol_].name}: </td>
                            <td/>
                            <td className="text-start" colSpan="4">{this.props.labels[o.Relative_loop_pos____tol_].value}</td>
                        </tr>
                        <tr>
                            <td className="text-start">{this.props.labels[o.Gaps].name}: </td>
                            <td/>
                            <td className="text-start">{this.props.labels[o.Gaps].value}</td>
                            <td className="text-start">{this.props.symbol_table[o.Wire_Dia].units}</td>
                            <td/>
                        </tr>
                        <tr>
                            <td className="text-start">{this.props.labels[o.Shot_peen].name}: </td>
                            <td/>
                            <td className="text-start">{this.props.labels[o.Shot_peen].value}</td>
                            <td colSpan="3" className="text-start">{"(calculations assume: " + this.peenValue + ")"}</td>
                        </tr>
                        <tr>
                            <td className="text-start">{this.props.labels[o.Stress_relieve_HT].name}: </td>
                            <td/>
                            <td className="text-start" colSpan="4">{this.props.labels[o.Stress_relieve_HT].value}</td>
                        </tr>
                        <tr>
                            <td className="text-start">{this.props.labels[o.Finish].name}: </td>
                            <td/>
                            <td className="text-start" colSpan="4">{this.props.labels[o.Finish].value}</td>
                        </tr>
                        <tr>
                            <td className="text-start">{this.props.labels[o.End_use].name}: </td>
                            <td/>
                            <td className="text-start" colSpan="4">{this.props.labels[o.End_use].value}</td>
                        </tr>
                        <tr>
                            <td className="text-start">{this.props.labels[o.Operating_temp].name}: </td>
                            <td/>
                            <td className="text-start">{this.props.labels[o.Operating_temp].value}</td>
                            <td/>
                        </tr>
                        <tr>
                            <td className="text-start">{this.props.labels[o.Special_notes___tol].name}: </td>
                            <td/>
                            <td className="text-start" colSpan="4">{this.props.labels[o.Special_notes___tol].value}</td>
                        </tr>
                        <tr>
                            <td/>
                        </tr>
