...
export const PC_Tensile_Bend = 42;
export const Stress_Lim_Endur = 43;
export const Stress_Lim_Stat = 44;
export const Stress_Lim_Bend = 45;
export const SI_Range = 46;
export const SI_Lo_Factor = 47;
export const SI_Hi_Factor = 48;
export const End_Type = 49;
export const End_ID = 50;
export const Extended_End_ID = 51;
export const L_End = 52;
export const L_Extended_End = 53;
export const Hook_Deflect_All = 54;
export const Catalog_Name = 55;
export const Catalog_Number = 56;
export const tbase010 = 57;
export const tbase400 = 58;
