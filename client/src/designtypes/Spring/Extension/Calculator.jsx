      ...
      <Row>
        <table className="w-100 report-table">
          <thead>
            <tr>
              <th></th>
              <ValueName name={<><b>Length</b><br />{symbol_table[o.L_Free].units}</>} tooltip="Length at initial point, point 1, point 2 and maximum safe point" className="text-center" />
              <ValueName name={<><b>Deflection</b><br />{symbol_table[o.L_Free].units}</>} tooltip="Deflection at initial point, point 1, point 2 and maximum safe point" className="text-center" />
              <ValueName name={<><b>Force</b><br />{symbol_table[o.Force_1].units}</>} tooltip="Force at initial point, point 1, point 2 and maximum safe point" className="text-center" />
              <ValueName name={<><b>OD</b><br />{symbol_table[o.OD_Free].units}</>} tooltip="Outside Diameter at initial point, point 1, point 2 and maximum safe point" className="text-center" />
              <ValueName name={<><b>ID</b><br />{symbol_table[o.ID_Free].units}</>} tooltip="Inside Diameter at initial point, point 1, point 2 and maximum safe point" className="text-center" />
              <ValueName name={<><b>Stress</b><br />{symbol_table[o.Stress_1].units}</>} tooltip="Stress at initial point, point 1, point 2 and maximum safe point" className="text-center" />
              <ValueName name={<><b>Static FS</b><br />{symbol_table[o.FS_2].units}</>} tooltip="Static Factor of Safety at initial point, point 1, point 2 and maximum safe point" className="text-center" />
            </tr>
          </thead>
          <tbody>
            <tr>
              <ValueName name={<b>Initial</b>} tooltip="Initial tension point" />
              <SymbolValue element={symbol_table[o.L_Free]} index={o.L_Free} />
              <Value id="Deflection_Free" value={0.0} />
              <SymbolValue element={symbol_table[o.Initial_Tension]} index={o.Initial_Tension} />
              <SymbolValue element={symbol_table[o.OD_Free]} index={o.OD_Free} />
              <SymbolValue element={symbol_table[o.ID_Free]} index={o.ID_Free} />
              <SymbolValue element={symbol_table[o.Stress_Initial]} index={o.Stress_Initial} />
              <Value id="Static FS_Free" value={(symbol_table[o.Stress_Lim_Stat].value / symbol_table[o.Stress_Initial].value)} />
            </tr>
            <tr>
              ...
              <SymbolValue element={symbol_table[o.Force_1]} index={o.Force_1} />
            ...
            <tr>
              ...
              <SymbolValue element={symbol_table[o.Force_2]} index={o.Force_2} />
            ...
            <tr>
              ...
              <Value id="Length_Max_Safe" value={(symbol_table[o.L_Free].value + base.safe_travel)} />
              ...
              <SymbolValue element={symbol_table[o.Stress_Lim_Stat]} index={o.Stress_Lim_Stat} />
        ...
        <table className="w-75 report-table">
          <tbody>
            <tr>
              ...
              <SymbolValue element={symbol_table[o.L_Stroke]} index={o.L_Stroke} />
              <SymbolUnits element={symbol_table[o.L_Stroke]} index={o.L_Stroke} className="text-start" />
              <td> &nbsp; &nbsp; </td>
          ...
          <table className="report-table">
            <tbody>
              <tr>
                ...
                <SymbolName className="text-end" element={symbol_table[o.L_Free]} index={o.L_Free} />
                <td>(w/ends)&nbsp;=</td>
                <SymbolValue element={symbol_table[o.L_Free]} index={o.L_Free} />
              ...
              <tr>
                ...
                <SymbolName className="text-center" element={symbol_table[o.L_End]} index={o.L_End} />
                <td className="text-center">----&gt;|&lt;---</td>
                <SymbolName className="text-center" element={symbol_table[o.L_Body]} index={o.L_Body} />
                <td className="text-center">----&gt;|&lt;---</td>
                <SymbolName className="text-center" element={symbol_table[o.End_Extension]} index={o.End_Extension} />
                <td className="text-center">----&gt;|&lt;---</td>
                <SymbolName className="text-center" element={symbol_table[o.L_Extended_End]} index={o.L_Extended_End} />
                <td className="text-end">----&gt;|</td>
              </tr>
              <tr>
                <td />
                <SymbolValue className="text-center" element={symbol_table[o.L_End]} index={o.L_End} />
                <td />
                <SymbolValue className="text-center" element={symbol_table[o.L_Body]} index={o.L_Body} />
                <td />
                <SymbolValue className="text-center" element={symbol_table[o.End_Extension]} index={o.End_Extension} />
                <td />
                <SymbolValue className="text-center" element={symbol_table[o.L_Extended_End]} index={o.L_Extended_End} />
                <td />
              </tr>
            </tbody>
          </table>
