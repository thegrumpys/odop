...
import { changeSymbolValue, fixSymbolValue, changeSymbolConstraint, loadInitialState, setSymbolFlag, changeLabelsValue, search } from '../../../store/modelActions';
    ...
    "steps": [
        ...
        },
        {
            ...
            actions: [
                ...
                changeLabelsValue([{name: 'COMMENT', value: 'Compression Spring demo1'}])
            ]
        },
        {
            title: "Page 03 of 11",
