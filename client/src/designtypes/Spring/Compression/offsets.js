...
export const End_Type_Method = 38;
export const End_Type = 39;
export const Closed_End_Geometry = 40;
export const End_Closure = 41;
export const Inactive_Coils = 42;
export const Taper_Amount = 43;
export const Pigtail_Amount = 44;
export const Grind_Amount = 45;
