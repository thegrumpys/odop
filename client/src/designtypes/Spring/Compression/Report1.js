            ...
            <React.Fragment>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{(0.0).toFixed(2)}</td>
                            <td> &nbsp; &nbsp; </td>
                            <td>{this.st[o.OD_Free].value.toFixed(4)}</td>
                            <td> &nbsp; &nbsp; </td>
                            <td>{this.st[o.ID_Free].value.toFixed(4)}</td>
                            <td> &nbsp; &nbsp; </td>
                            <td>{(0.0).toFixed(0)}</td>
                            <td> &nbsp; &nbsp; </td>
                            <td>infinite</td>
                        ...
                        <tr>
                            ...
                            <td> &nbsp; &nbsp; </td>
                            <td>{(this.od_solid - 2.0 * this.st[o.Wire_Dia].value).toFixed(4)}</td>
                            <td> &nbsp; &nbsp; </td>
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td>{this.st[o.L_Stroke].name}</td>
                            <td>=</td>
                            <td>{this.st[o.L_Stroke].value.toFixed(3)}</td>
                            <td>{this.st[o.L_Stroke].units}</td>
                            <td/>
                            <td> &nbsp; &nbsp; </td>
