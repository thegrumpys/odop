...
//        console.log('After: design=',design);
    ...
    case '13':
        ...
        design.symbol_table.splice(46,0,initialSymbol('Closed_End_Geometry'));
        design.symbol_table.splice(47,0,initialSymbol('End_Closure'));
        ...
        switch (oldEndType) {
          case 1: // Old "Open"
            design.symbol_table[46].value = 0; // Closed_End_Geometry not applicable
            design.symbol_table[47].value = 1; // End_Closure "Open"
            break;
          case 2: // Old "Open&Ground"
            ...
            break;
          case 3: // Old "Closed"
            design.symbol_table[46].value = 1; // Closed_End_Geometry "Single"
            design.symbol_table[47].value = 2; // End_Closure "Closed"
            break;
          ...
          case 5: // Old "Tapered_C&G"
            ...
            design.symbol_table[46].value = 3; // Closed_End_Geometry "Tapered"
            design.symbol_table[47].value = 2; // End_Closure "Closed"
          ...
          case 6: // Old "Pig-tail"
            ...
            design.symbol_table[46].value = 4; // Closed_End_Geometry "Pigtail"
            design.symbol_table[47].value = 2; // End_Closure "Closed"
