...
//        console.log('After: design=',design);
    ...
    case '12':
        ...
        design.symbol_table[31].value += 1; // Increment Material_Type to skip over new User_Specified row
        if (design.symbol_table[30].value !== 1) { // If Prop_Calc_Method is not 1 (either 2 or 3)
            ...
            design.symbol_table[31].value = 1; // Set Material_Type to User_Specified
        }
