            ...
            <>
                ...
                <table id="view3" className="report-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="text-start">{this.props.symbol_table[o.L_1].units}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className="text-start">{this.props.symbol_table[o.FS_Solid].units}</td>
                        </tr>
                        <tr>
                            <td/>
                            <td className="text-start" colSpan="5"><sup>*</sup> without pre-set &nbsp; kw = {this.kw1.toFixed(3)}</td>
                        </tr>
                    </tbody>
                </table>
                <br/>
                ...
                <table id="view4" className="report-table">
                    <tbody>
                        ...
                        <tr>
                            <td className="text-start">{this.props.labels[o.Pre_set].name}: </td>
                            <td/>
                            <td className="text-start">{this.props.labels[o.Pre_set].value}</td>
                        ...
                        <tr>
                            <td className="text-start">{this.props.labels[o.Squareness].name}: </td>
                            <td/>
                            <td className="text-start">{this.props.labels[o.Squareness].value}</td>
                        ...
                        <tr>
                            <td className="text-start">{this.props.labels[o.Fits_in___Works_over].name}: </td>
                            <td/>
                            <td className="text-start">{this.props.labels[o.Fits_in___Works_over].value}</td>
                            <td className="text-start">{this.props.symbol_table[o.ID_Free].units}</td>
                        </tr>
                        <tr>
