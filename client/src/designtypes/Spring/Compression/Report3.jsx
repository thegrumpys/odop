...
//    console.log("In Report3.onClick event=",event);
  ...
  return (
    <>
      ...
      <table id="view3" className="report-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{(symbol_table[o.L_Free].value - symbol_table[o.L_Solid].value).toFixed(3)}</td>
          ...
          <tr>
            ...
            <td>{(base.od_solid - 2.0 * symbol_table[o.Wire_Dia].value).toFixed(3)}</td>
          ...
          <tr>
            ...
            <td className="text-start">{symbol_table[o.FS_Solid].units}</td>
          </tr>
          <tr>
            <td />
      ...
      <br />
      Deflection at 2nd load is {symbol_table[o.PC_Avail_Deflect].value.toFixed(0)}% of total available deflection.<br />
      ...
      <table id="view4" className="report-table">
        <tbody>
          ...
          <tr>
            <td className="text-start">{labels[o.Pre_set].name}: </td>
            <td />
            <td className="text-start">{labels[o.Pre_set].value}</td>
          ...
          <tr>
            <td className="text-start">{labels[o.Squareness].name}: </td>
            <td />
            <td className="text-start">{labels[o.Squareness].value}</td>
          ...
          <tr>
            <td className="text-start">{labels[o.Fits_in___Works_over].name}: </td>
            <td />
            <td className="text-start">{labels[o.Fits_in___Works_over].value}</td>
            <td className="text-start">{symbol_table[o.ID_Free].units}</td>
          </tr>
          <tr>
