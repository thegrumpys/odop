...
import { changeSymbolValue, changeSymbolConstraint, setSymbolFlag, search } from '../../../store/actionCreators';
...
export const execute = {
    steps: [
        ...
        },
        {
            text: (
                <React.Fragment>
                   <img src="designtypes/Spring/Compression/ForceVsDeflection.png" alt="ForceVsDeflection diagram"/>
                </React.Fragment>
            )
        },
        {
