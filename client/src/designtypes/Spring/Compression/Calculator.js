                    ...
                    <table className="report-table">
                        <thead>
                            <tr>
                                ...
                                <ValueName name={<><b>Deflect</b><br />{this.props.symbol_table[o.L_Free].units}</>} tooltip="Deflection at free point, point 1, point 2 and solid point" className="text-center" />
