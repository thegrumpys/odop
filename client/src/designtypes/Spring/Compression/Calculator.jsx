                    ...
                    <table className="report-table">
                        <tbody>
                            <tr>
                                ...
                                <SymbolUnits element={this.props.symbol_table[o.L_Stroke]} index={o.L_Stroke} className="text-start" />
                                <td> &nbsp; &nbsp; </td>
                            ...
                            <tr>
                                ...
                                <SymbolUnits element={this.props.symbol_table[o.L_Free]} index={o.L_Free} className="text-start" />
                                <td> &nbsp; &nbsp; </td>
