        ...
        <Row>
          <table className="report-table">
            <thead>
              <tr>
                <th></th>
                <ValueName name={<><b>Length</b><br />{symbol_table[o.L_Free].units}</>} tooltip="Length at free point, point 1, point 2 and solid point" className="text-center" />
                <ValueName name={<><b>Deflection</b><br />{symbol_table[o.L_Free].units}</>} tooltip="Deflection at free point, point 1, point 2 and solid point" className="text-center" />
                <ValueName name={<><b>Force</b><br />{symbol_table[o.Force_1].units}</>} tooltip="Force at free point, point 1, point 2 and solid point" className="text-center" />
                <ValueName name={<><b>OD</b><br />{symbol_table[o.OD_Free].units}</>} tooltip="Outside Diameter at free point, point 1, point 2 and solid point" className="text-center" />
                <ValueName name={<><b>ID</b><br />{symbol_table[o.ID_Free].units}</>} tooltip="Inside Diameter at free point, point 1, point 2 and solid point" className="text-center" />
                <ValueName name={<><b>Stress</b><br />{symbol_table[o.Stress_1].units}</>} tooltip="Stress at free point, point 1, point 2 and solid point" className="text-center" />
                <ValueName name={<><b>Static FS</b><br />{symbol_table[o.FS_2].units}</>} tooltip="Static Factor of Safety at free point, point 1, point 2 and solid point" className="text-center" />
              </tr>
            </thead>
            <tbody>
              <tr>
              ...
              <tr>
                ...
                <SymbolValue element={symbol_table[o.L_Solid]} index={o.L_Solid} />
                <Value id="Deflection_Solid" value={(symbol_table[o.L_Free].value - symbol_table[o.L_Solid].value)} />
                <SymbolValue element={symbol_table[o.Force_Solid]} index={o.Force_Solid} />
                <Value id="OD_Solid" value={base.od_solid} />
                <Value id="ID_Solid" value={(base.od_solid - 2.0 * symbol_table[o.Wire_Dia].value)} />
                <SymbolValue element={symbol_table[o.Stress_Solid]} index={o.Stress_Solid} />
                <SymbolValue element={symbol_table[o.FS_Solid]} index={o.FS_Solid} />
              </tr>
            </tbody>
          </table>
        </Row>
          ...
          <table className="report-table">
            <tbody>
              ...
              <tr>
                ...
                <SymbolUnits element={symbol_table[o.L_Free]} index={o.L_Free} className="text-start" />
                <td> &nbsp; &nbsp; </td>
          ...
          <table className="report-table">
            <tbody>
              <tr>
                ...
                <SymbolValue element={symbol_table[o.PC_Avail_Deflect]} index={o.PC_Avail_Deflect} />
                <td>
