    ...
    <Container>
      ...
      <Row>
        <table className="w-auto report-table">
          <thead>
            <tr>
              <th></th>
              <ValueName name={<><b>Length</b><br />{model_symbol_table[o.L_1].units}</>} tooltip="Length at free point, point 1, point 2 and maximum safe point" className="text-center" />
              <ValueName name={<><b>Deflection</b><br />{model_symbol_table[o.Deflect_1].units}</>} tooltip="Deflection at free point, point 1, point 2 and maximum safe point" className="text-center" />
              <ValueName name={<><b>Moment</b><br />{model_symbol_table[o.M_1].units}</>} tooltip="Moment at free point, point 1, point 2 and maximum safe point" className="text-center" />
              <ValueName name={<><b>OD</b><br />{model_symbol_table[o.OD_Free].units}</>} tooltip="Outside Diameter at free point, point 1, point 2 and maximum safe point" className="text-center" />
              <ValueName name={<><b>ID</b><br />{model_symbol_table[o.ID_Free].units}</>} tooltip="Inside Diameter at free point, point 1, point 2 and maximum safe point" className="text-center" />
              <ValueName name={<><b>Stress</b><br />{model_symbol_table[o.Stress_1].units}</>} tooltip="Stress at free point, point 1, point 2 and maximum safe point" className="text-center" />
              <ValueName name={<><b>Static FS</b><br />{model_symbol_table[o.FS_2].units}</>} tooltip="Static Factor of Safety at free point, point 1, point 2 and maximum safe point" className="text-center" />
            </tr>
          </thead>
          <tbody>
            <tr>
              <ValueName name={<b>Free</b>} tooltip="Free or no torsion point" />
              <SymbolValue element={model_symbol_table[o.L_Body]} index={o.L_Body} />
            ...
            <tr>
              ...
              <SymbolValue element={model_symbol_table[o.M_1]} index={o.M_1} />
            ...
            <tr>
              ...
              <SymbolValue element={model_symbol_table[o.M_2]} index={o.M_2} />
            ...
            <tr>
              ...
              <Value id="ID_Max_Safe" value={base.od_max - (2.0 * model_symbol_table[o.Wire_Dia].value)} />
              <SymbolValue element={model_symbol_table[o.Stress_Lim_Bnd_Stat]} index={o.Stress_Lim_Bnd_Stat} />
      ...
      <Row>
        <table className="w-auto report-table">
          <tbody>
            <tr>
              <SymbolName element={model_symbol_table[o.Stroke]} index={o.Stroke} />
              <SymbolValue element={model_symbol_table[o.Stroke]} index={o.Stroke} />
              <SymbolUnits element={model_symbol_table[o.Stroke]} index={o.Stroke} className="text-start" />
              <td> &nbsp; &nbsp; </td>
            ...
            <tr>
              <SymbolName element={model_symbol_table[o.Coil_Spacing]} index={o.Coil_Spacing} />
              <SymbolValue element={model_symbol_table[o.Coil_Spacing]} index={o.Coil_Spacing} />
              <SymbolUnits element={model_symbol_table[o.Coil_Spacing]} index={o.Coil_Spacing} className="text-start" />
              <td> &nbsp; &nbsp; </td>
            ...
            <tr>
              <SymbolName element={model_symbol_table[o.End_Angle_Free]} index={o.End_Angle_Free} />
              <SymbolValue element={model_symbol_table[o.End_Angle_Free]} index={o.End_Angle_Free} />
              <SymbolUnits element={model_symbol_table[o.End_Angle_Free]} index={o.End_Angle_Free} className="text-start" />
              <td> &nbsp; &nbsp; </td>
              <ValueName name="Pitch" tooltip="Pitch is the distance between two adjacent coils" />
              <Value id="Pitch" value={base.pitch} />
              <SymbolUnits element={model_symbol_table[o.L_Body]} index={o.L_Body} className="text-start" />
            </tr>
            <tr>
              <SymbolName element={model_symbol_table[o.Arm_2]} index={o.Arm_2} />
              <SymbolValue element={model_symbol_table[o.Arm_2]} index={o.Arm_2} />
              <SymbolUnits element={model_symbol_table[o.Arm_2]} index={o.Arm_2} className="text-start" />
              <td> &nbsp; &nbsp; </td>
              <SymbolName element={model_symbol_table[o.Force_Arm_2]} index={o.Force_Arm_2} />
              <SymbolValue element={model_symbol_table[o.Force_Arm_2]} index={o.Force_Arm_2} />
              <SymbolUnits element={model_symbol_table[o.Force_Arm_2]} index={o.Force_Arm_2} className="text-start" />
            </tr>
            <tr>
