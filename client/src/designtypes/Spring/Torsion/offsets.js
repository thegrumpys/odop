...
export const Inactive_Coils = 30;
export const Density = 31;
export const Elastic_Modulus = 32;
export const Hot_Factor_Kh = 33;
export const Tensile = 34;
export const PC_Ten_Bnd_Endur = 35;
export const PC_Ten_Bnd_Stat = 36;
export const Stress_Lim_Bnd_Endur = 37;
export const Stress_Lim_Bnd_Stat = 38;
export const End_Type = 39;
