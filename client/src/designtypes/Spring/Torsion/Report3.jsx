        ...
        return (
            <>
                <h4 className="d-flex mt-3">
                    <span className="ms-auto">ODOP:Spring &nbsp; Torsion Spring Report &nbsp; &nbsp; <a href="https://www.springdesignsoftware.org"><small>https://www.springdesignsoftware.org</small></a></span>
                ...
                <table id="view3" className="report-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{this.safe_load.toFixed(3)}</td>
                            <td className="text-start" colSpan="2">{this.props.symbol_table[o.M_1].units}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className="text-start">{this.props.symbol_table[o.PC_Ten_Bnd_Stat].units}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td/>
                            <td className="text-start" colSpan="4"><sup>*</sup> kb = {this.kb.toFixed(3)} &nbsp; ({this.heattreatValue})</td>
                        </tr>
                    </tbody>
                </table>
                <hr/>
                ...
                <table id="view4" className="report-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td/>
                            <td className="text-start">{this.props.labels[o.Stress_relieve_HT].value}</td>
                            <td colSpan="3" className="text-start">{"(calculations assume: " + this.heattreatValue + ")"}</td>
                        </tr>
                        <tr>
                            <td className="text-start">{this.props.labels[o.Relative_end_pos____tol_].name}: </td>
                            <td/>
                            <td className="text-start" colSpan="4">{this.props.labels[o.Relative_end_pos____tol_].value}</td>
                        </tr>
                        <tr>
