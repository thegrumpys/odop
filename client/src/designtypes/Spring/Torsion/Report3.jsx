...
//    console.log('In Report3.onClick event=',event);
  ...
  return (
    <>
      ...
      <table id="view2" className="report-table">
        <tbody>
          ...
          <tr>
            ...
            <td>=</td>
            <td>{model_symbol_table[o.End_Angle_Free].value.toFixed(1)}</td>
      ...
      <table id="view3" className="report-table">
        ...
        <tbody>
          <tr>
            <td><b>Moment</b></td>
            <td>{(0.0).toFixed(3)}</td>
            <td>{model_symbol_table[o.M_1].value.toFixed(3)}</td>
            <td>{model_symbol_table[o.M_2].value.toFixed(3)}</td>
            <td>{base.safe_load.toFixed(3)}</td>
            <td className="text-start" colSpan="2">{model_symbol_table[o.M_1].units}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>{(base.od_max - 2.0 * model_symbol_table[o.Wire_Dia].value).toFixed(3)}</td>
          ...
          <tr>
            ...
            <td className="text-start">{model_symbol_table[o.PC_Ten_Bnd_Stat].units}</td>
          </tr>
          <tr>
            ...
            <td>{1.0.toFixed(2)}</td>
            <td className="text-start">{model_symbol_table[o.FS_2].units}</td>
          </tr>
          <tr>
            <td />
      ...
      <hr />
      Deflection at load point 2 is {(100.0 * model_symbol_table[o.Deflect_2].value / base.def_max).toFixed(0)}% of total safe deflection.<br />
      <hr />
      <table id="view4" className="report-table">
        <tbody>
          ...
          <tr>
            ...
            <td />
            <td className="text-start">{model_labels[o.Stress_relieve_HT].value}</td>
            <td colSpan="3" className="text-start">{"(calculations assume: " + base.heattreatValue + ")"}</td>
          </tr>
          <tr>
            <td className="text-start">{model_labels[o.Relative_end_pos____tol_].name}: </td>
            <td />
            <td className="text-start" colSpan="4">{model_labels[o.Relative_end_pos____tol_].value}</td>
          </tr>
          <tr>
