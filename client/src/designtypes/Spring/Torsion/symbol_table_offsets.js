...
export const Elastic_Modulus = 38;
export const Hot_Factor_Kh = 39;
export const Tensile = 40;
export const PC_Ten_Bnd_Endur = 41;
export const PC_Ten_Bnd_Stat = 42;
export const Stress_Lim_Bnd_Endur = 43;
export const Stress_Lim_Bnd_Stat = 44;
