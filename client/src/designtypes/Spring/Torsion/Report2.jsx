                ...
                <table id="view1" className="report-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="text-start">{this.props.symbol_table[o.Elastic_Modulus].units}</td>
                        </tr>
                        <tr>
                ...
                <table id="view5" className="report-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>=</td>
                            <td>{this.props.symbol_table[o.Stress_Lim_Bnd_Stat].value.toFixed(0)}</td>
                            <td className="text-start">{this.props.symbol_table[o.Stress_Lim_Bnd_Stat].units}</td>
                            <td/>
                            ...
                            <td className="text-start">{this.props.symbol_table[o.Stress_Lim_Bnd_Endur].units}</td>
                        </tr>
                        <tr>
                            <td/>
                            <td/>
                        ...
                        <table id="view7" className="report-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td className="text-start">{this.props.symbol_table[o.PC_Ten_Bnd_Endur].units}</td>
                                </tr>
                                <tr>
