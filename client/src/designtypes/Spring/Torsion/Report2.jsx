    ...
    <>
      ...
      <table id="view1" className="report-table">
        <tbody>
          ...
          <tr>
            ...
            <td />
            <td>{symbol_table[o.Elastic_Modulus].name}</td>
            <td>=</td>
            <td>{symbol_table[o.Elastic_Modulus].value}</td>
            <td className="text-start">{symbol_table[o.Elastic_Modulus].units}</td>
          </tr>
          <tr>
      ...
      <table id="view2" className="report-table">
        <tbody>
          ...
          <tr>
            <td />
            <td className="text-center"><b>Moment</b><br />{symbol_table[o.M_1].units}</td>
            <td className="text-center"><b>Deflect</b><br />{symbol_table[o.Deflect_1].units}</td>
            <td className="text-center"><b>Length</b><br />{symbol_table[o.L_Body].units}</td>
            <td />
            <td />
        ...
        <tbody>
          ...
          <tr>
            <td><b>1</b></td>
            <td>{symbol_table[o.M_1].value.toFixed(2)}</td>
          ...
          <tr>
            <td><b>2</b></td>
            <td>{symbol_table[o.M_2].value.toFixed(2)}</td>
      ...
      <table id="view5" className="report-table">
        <tbody>
          ...
          <tr>
            <td>{symbol_table[o.Stress_Lim_Bnd_Stat].name}</td>
            <td>=</td>
            <td>{symbol_table[o.Stress_Lim_Bnd_Stat].value.toFixed(0)}</td>
            <td className="text-start">{symbol_table[o.Stress_Lim_Bnd_Stat].units}</td>
            <td />
            <td>{symbol_table[o.Stress_Lim_Bnd_Endur].name}<sup>*</sup></td>
            <td>=</td>
            <td>{symbol_table[o.Stress_Lim_Bnd_Endur].value.toFixed(0)}</td>
            <td className="text-start">{symbol_table[o.Stress_Lim_Bnd_Endur].units}</td>
          </tr>
          <tr>
            <td />
            <td />
          ...
          <table id="view7" className="report-table">
            <tbody>
              ...
              <tr>
                ...
                <td className="text-start">{symbol_table[o.Tensile].units}</td>
                <td />
                <td>{symbol_table[o.PC_Ten_Bnd_Endur].name}<sup>*</sup></td>
                <td>=</td>
                <td>{symbol_table[o.PC_Ten_Bnd_Endur].value.toFixed(0)}</td>
                <td className="text-start">{symbol_table[o.PC_Ten_Bnd_Endur].units}</td>
              </tr>
              <tr>
