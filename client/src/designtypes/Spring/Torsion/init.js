...
//    torsion_modulus  = m_tab(i).gg;
    st[o.Elastic_Modulus] = ten3 * m_tab[i][mo.ee];
//
...
//    tensile_400      = m_tab(i).t400;
    ...
    switch(st[o.Life_Category]){
        ...
        case 1:
        case 5:
            st[o.PC_Ten_Bnd_Endur] = m_tab[i][mo.ptb1];
        break;
        case 2:
            st[o.PC_Ten_Bnd_Endur] = m_tab[i][mo.ptb2];
        break;
        case 3:
            st[o.PC_Ten_Bnd_Endur] = m_tab[i][mo.ptb3];
        break;
        case 4:
            st[o.PC_Ten_Bnd_Endur] = m_tab[i][mo.ptb4];
        break;
        case 6:
            st[o.PC_Ten_Bnd_Endur] = m_tab[i][mo.ptb6];
        break;
        case 7:
            st[o.PC_Ten_Bnd_Endur] = m_tab[i][mo.ptb7];
        break;
        case 8:
            st[o.PC_Ten_Bnd_Endur] = m_tab[i][mo.ptb8];
    }
    
//    pc_tensile_stat  = m_tab(i).fy;
    st[o.PC_Ten_Bnd_Stat]  = m_tab[i][mo.ptb1];
