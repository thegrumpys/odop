                    ...
                    <table className="report-table">
                        <thead>
                            <tr>
                                ...
                                <ValueName name={<><b>Deflect</b><br />{this.props.symbol_table[o.Deflect_1].units}</>} tooltip="Deflection at free point, point 1, point 2 and maximum safe point" className="text-center" />
