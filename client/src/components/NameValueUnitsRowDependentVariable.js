            ...
            <tbody>
                <tr key={this.props.element.name}>
                    ...
                    <td className="align-middle" colSpan="2">
                        <InputGroup>
                            <FormControlTypeNumber id={'nvurdv_'+this.props.element.name} disabled={true} icon_alerts={icon_alerts} className={value_class} value={this.props.element.value} value_tooltip={value_tooltip} validmin={this.props.element.validmin} validmax={this.props.element.validmax} />
                            <InputGroup.Append>
                                <InputGroup.Text>
