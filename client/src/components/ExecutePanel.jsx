...
import { setExecuteName, setShow, setPrefix, setSteps, setstep, setTitle, setText, setTestGenerate } from '../store/executePanelSlice';
...
export var startExecute = (prefix, executeName, steps) => {
  ...
  if (steps !== undefined && steps[0] !== undefined) {
    ...
    if (steps[0].actions !== undefined) {
      ...
      if (localTestGenerate) outputLine('    // No-op');
    }
    window.scrollTo(0, 0);
  }
}
