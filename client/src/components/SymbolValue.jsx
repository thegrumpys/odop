...
//       console.log('In SymbolValue.onResetButton');
    ...
    const { store } = context;
    store.dispatch(load(JSON.parse(reset)));
    setModified(false);
  }
                ...
                <tbody>
                  <tr>
                    <td>
                      ...
                      This allows <img src="SearchButton.png" alt="SearchButton" /> to find the Dependent Variable's value that is within constraint range.
                    </td>
                  </tr>
                </tbody>
              </Table>}
