            ...
            <tbody>
                <tr key={this.props.element.name}>
                        ...
                        <InputGroup>
                            ...
                            {(this.props.element.lmin & FIXED) === 0 && this.props.element.cminchoices !== undefined && this.props.element.cminchoices.length > 0 ?
                                <OverlayTrigger placement="top" overlay={<Tooltip>{this.props.element.lmin & FDCL ? 'FDCL =' + this.props.element.cminchoices[this.props.element.cminchoice] : '=' + this.props.element.cmin + ' (non-FDCL)'}</Tooltip>}>
                                    <FormControlTypeNumber id={this.props.element.name + "_cmin"} className={value_class} value={this.props.element.cmin} disabled={this.props.element.lmin & FIXED ? true : (this.props.element.lmin & CONSTRAINED ? false : true)} disabledText={this.props.element.lmin & CONSTRAINED ? false : true} onChangeValid={this.onChangeValidMinConstraint} onChangeInvalid={this.onChangeInvalidMinConstraint} onClick={this.onClick}/>
                                </OverlayTrigger>
                            :
                                <FormControlTypeNumber id={this.props.element.name + "_cmin"} className={value_class} value={this.props.element.cmin} disabled={this.props.element.lmin & FIXED ? true : (this.props.element.lmin & CONSTRAINED ? false : true)} disabledText={this.props.element.lmin & CONSTRAINED ? false : true} onChangeValid={this.onChangeValidMinConstraint} onChangeInvalid={this.onChangeInvalidMinConstraint} onClick={this.onClick}/>
                            }
                    ...
                    <td className={"text-right align-middle small " + value_class + (this.props.system_controls.show_violations.value === 0 ? "d-none" : "")} colSpan="1">
                        {this.props.system_controls.show_violations.value === 1 && this.props.element.vmin <= 0 ?
                            ''
