        ...
        return (
            <React.Fragment>
                <tr key={this.props.element.name}>
                    ...
                    { this.props.element.tooltip !== undefined && <Tooltip class="d-lg-none" placement="top" target={'independent_variable_min_constrain_'+this.props.index}>{this.props.element.tooltip}</Tooltip>}
                    <td className="align-middle" colSpan="2">
                        <InputGroup>
                            <InputGroup.Prepend>
                                <InputGroup.Text>
                                    <Form.Check type="checkbox" addon aria-label="Checkbox for minimum value" checked={this.props.element.lmin & CONSTRAINED} onChange={this.props.element.lmin & CONSTRAINED ? this.onResetIndependentVariableFlagConstrained : this.onSetIndependentVariableFlagConstrained} disabled={this.props.element.lmin & FIXED ? true : false} />
                                </InputGroup.Text>
                            </InputGroup.Prepend>
