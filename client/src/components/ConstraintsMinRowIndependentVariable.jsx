    ...
    return (
      ...
      <tr key={this.props.element.name}>
        <td className="align-middle d-lg-none" id={'independent_variable_min_constrain_' + this.props.index}>
          ...
          <Tooltip className="d-lg-none">{this.props.element.tooltip}</Tooltip>}>
        ...
        <td className="align-middle" colSpan="2">
          <InputGroup>
            ...
            <FormControlTypeNumber id={this.props.element.name + '_cmin'} icon_alerts={icon_alerts}
                                   ...
                                   disabled={this.props.element.lmin & FIXED ? true : (this.props.element.lmin &
                                   CONSTRAINED ? false : true)}
                                   disabledText={this.props.element.lmin & CONSTRAINED ? false : true}
                                   onChangeValid={this.onChangeValidMinConstraint}
                                   onChangeInvalid={this.onChangeInvalidMinConstraint} onClick={this.onClick}/>
          </InputGroup>
                ...
                <Table borderless="true">
                  ...
                  <tr>
                    ...
                    <td>
                      <InputGroup>
                        <ButtonGroup>
                          {this.props.element.cminchoices.map((e) => {
                            return (
                              <Button key={e} variant="primary" onClick={(event) => {this.onVariableButton(event, e)}}
                                      style={{ marginBotton: '5px' }}
                                      active={this.props.element.cminchoices[this.props.element.cminchoice] ===
                                      e}>{e}</Button>
                            )
                          })}
                        </ButtonGroup>
                  ...
                  <tr>
                    ...
                    <td>
                      <InputGroup>
                        <FormControlTypeNumber id={this.props.element.name + '_cmin'} className={className}
                                               value={this.props.element.cmin} validmin={this.props.element.validmin}
                                               validmax={this.props.element.validmax}
                                               onChangeValid={this.onChangeValidValue}
                                               onChangeInvalid={this.onChangeInvalidValue}/>
                        <Button variant="primary" disabled={this.state.isInvalidValue}
                                onClick={this.onEnterButton}>Enter</Button>
                      </InputGroup>
                    </td>
                  </tr>
                  </tbody>
        ...
        <td className={'text-right align-middle small ' + className +
        (this.props.system_controls.show_violations === 0 ? 'd-none' : '')} colSpan="1">
