        ...
        return (
            <React.Fragment>
                <Table className="col-md-3 border border-secondary" size="sm">
                    ...
                    <tbody>
                        {this.props.symbol_table.map((element) => element.input && <ConstraintsMinRowIndependentVariable key={element.name} element={element} />)}
                    </tbody>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        {this.props.symbol_table.map((element) => !element.input && <ConstraintsMinRowDependentVariable key={element.name} element={element} />)}
                    </tbody>
                </Table>
