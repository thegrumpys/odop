                ...
                <tr key={this.props.element.name}>
                    ...
                    <td className="align-middle" colSpan="2">
                        <InputGroup>
                            ...
                            <FormControlTypeNumber id={this.props.element.name + "_cmin"} className={value_class} value={this.props.element.cmin} value_tooltip={value_tooltip} validmin={this.props.element.validmin} validmax={this.props.element.validmax} disabled={this.props.element.lmin & FIXED || this.props.element.lmin & CONSTRAINED ? false : true} disabledText={this.props.element.lmin & CONSTRAINED ? false : true} onChangeValid={this.onChangeValidMinConstraint} onChangeInvalid={this.onChangeInvalidMinConstraint} onClick={this.onClick}/>
                        </InputGroup>
