...
//                console.log('In NameValueUnitsRowCalcInput.onSelect name=',name,' this.props.symbol_table=',this.props.symbol_table,' check=',Object.values(this.props.symbol_table).find(element => element.name === name));
