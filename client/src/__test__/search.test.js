...
it('search without merit', () => {
    ...
    expect(design.version).toEqual("4");
...
it('search with merit', () => {
    ...
    var SDIR = -1; // MIN
    var temp = design.symbol_table[sto.STRESS].value;
    var M_NUM = temp + 0.1 * SDIR * temp;
    var M_DEN = Math.abs(M_NUM) / design.system_controls.mfn_wt;
...
//        console.log('In merit ', m_funct);
    ...
    expect(design.symbol_table[sto.PRESSURE].name).toEqual("PRESSURE"); // p vector
    expect(design.symbol_table[sto.PRESSURE].value).toEqual(1218.7216061774907);
    expect(design.symbol_table[sto.RADIUS].name).toEqual("RADIUS");
    expect(design.symbol_table[sto.RADIUS].value).toEqual(0.5077056314821616);
    expect(design.symbol_table[sto.THICKNESS].name).toEqual("THICKNESS");
    expect(design.symbol_table[sto.THICKNESS].value).toEqual(0.05068299199335332);
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE"); // x vector
    expect(design.symbol_table[sto.FORCE].value).toEqual(986.9118066777166);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(0.809792656235214);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(6104.136696847354);
