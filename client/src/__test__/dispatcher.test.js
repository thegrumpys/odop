...
it('middleware with startup', () => {
    ...
    expect(design.symbol_table[sto.PRESSURE].smin).toEqual(undefined);
    expect(design.symbol_table[sto.PRESSURE].smax).toEqual(undefined);
    ...
    expect(design.symbol_table[sto.RADIUS].smax).toEqual(undefined);
    ...
    expect(design.symbol_table[sto.THICKNESS].smin).toEqual(undefined);
    ...
    expect(design.symbol_table[sto.FORCE].smin).toEqual(undefined);
    expect(design.symbol_table[sto.FORCE].smax).toEqual(undefined);
    ...
    expect(design.symbol_table[sto.AREA].smin).toEqual(undefined);
    expect(design.symbol_table[sto.AREA].smax).toEqual(undefined);
...
it('middleware change pressure design parameter value without startup', () => {
    ...
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(2513.2741228718348);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(0.5026548245743669);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(25000);
});
...
it('middleware change radius design parameter value without startup', () => {
    ...
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(392.6990816987241);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(0.7853981633974483);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(3125);
});
...
it('middleware change thickness design parameter value without startup', () => {
    ...
    expect(design.symbol_table[sto.AREA].value).toEqual(0.5026548245743669);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(2000);
});
//=====================================================================
// CONSTRAINTS
//=====================================================================
...
it('middleware search2: initial state w/ single SV constraint modified', () => {
    ...
    expect(design.symbol_table[sto.RADIUS].name).toEqual("RADIUS");
    expect(design.symbol_table[sto.RADIUS].value).toEqual(0.4877369775989805);
    expect(design.symbol_table[sto.THICKNESS].name).toEqual("THICKNESS");
    expect(design.symbol_table[sto.THICKNESS].value).toEqual(0.040000000000000056);
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(1038.1511075527435);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(0.7473451804133828);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(8469.056480847505);
...
it('middleware search3: initial state w/ single DP FIXed', () => {
    ...
    expect(design.symbol_table[sto.RADIUS].name).toEqual("RADIUS");
    expect(design.symbol_table[sto.RADIUS].value).toEqual(0.444);
    expect(design.symbol_table[sto.THICKNESS].name).toEqual("THICKNESS");
    expect(design.symbol_table[sto.THICKNESS].value).toEqual(0.06000128769964651);
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(602.2450480774055);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(0.6193210093580775);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(3597.9061295858437);
...
it('middleware search4: initial state w/ single SV FIXed', () => {
    ...
    expect(design.symbol_table[sto.RADIUS].name).toEqual("RADIUS");
    expect(design.symbol_table[sto.RADIUS].value).toEqual(0.5744582590062994);
    expect(design.symbol_table[sto.THICKNESS].name).toEqual("THICKNESS");
    expect(design.symbol_table[sto.THICKNESS].value).toEqual(0.05745198212666806);
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(778.0646709106514);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(1.0367327741432661);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(3752.0821052003944);
...
it('middleware search5: initial state w/ 3 constraints modified', () => {
    ...
    expect(design.symbol_table[sto.RADIUS].name).toEqual("RADIUS");
    expect(design.symbol_table[sto.RADIUS].value).toEqual(0.47955021080064064);
    expect(design.symbol_table[sto.THICKNESS].name).toEqual("THICKNESS");
    expect(design.symbol_table[sto.THICKNESS].value).toEqual(0.05993925712603883);
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(695.0452267187616);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(0.7224670506971189);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(3848.4668895888885);
...
it('middleware search6: initial state w/ 3 constraints modified further', () => {
    ...
    expect(design.symbol_table[sto.RADIUS].name).toEqual("RADIUS");
    expect(design.symbol_table[sto.RADIUS].value).toEqual(0.6601769508494637);
    expect(design.symbol_table[sto.THICKNESS].name).toEqual("THICKNESS");
    expect(design.symbol_table[sto.THICKNESS].value).toEqual(0.06031483281717521);
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(1023.0396666167936);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(1.3692116561571288);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(4089.103647517854);
...
it('middleware search7: initial state w/ 2 constraints modified, 1 SV FIXed', () => {
    ...
    expect(design.symbol_table[sto.RADIUS].name).toEqual("RADIUS");
    expect(design.symbol_table[sto.RADIUS].value).toEqual(0.6599935713499682);
    expect(design.symbol_table[sto.THICKNESS].name).toEqual("THICKNESS");
    expect(design.symbol_table[sto.THICKNESS].value).toEqual(0.06041228804212965);
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(1048.9614321530885);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(1.3684511010499278);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(4187.112814828608);
...
it('middleware seek1 min stress; feasible start; no fixed', () => {
    ...
    expect(design.symbol_table[sto.RADIUS].name).toEqual("RADIUS");
    expect(design.symbol_table[sto.RADIUS].value).toEqual(0.5025499901050051);
    expect(design.symbol_table[sto.THICKNESS].name).toEqual("THICKNESS");
    expect(design.symbol_table[sto.THICKNESS].value).toEqual(0.05031359856496264);
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(995.2481203224017);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(0.7934296216257505);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(6264.506274188985);
...
it('middleware seek2 min stress; alt start pt, opened constraints, feasible start; no fixed', () => {
    ...
    expect(design.symbol_table[sto.RADIUS].name).toEqual("RADIUS");
    expect(design.symbol_table[sto.RADIUS].value).toEqual(0.7495610043125683);
    expect(design.symbol_table[sto.THICKNESS].name).toEqual("THICKNESS");
    expect(design.symbol_table[sto.THICKNESS].value).toEqual(0.06531967146069526);
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(997.5475007697938);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(1.7650777546433516);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(3242.6699011968067);
...
it('middleware seek3 min stress; infeasible start; no fixed', () => {
    ...
    expect(design.symbol_table[sto.THICKNESS].value).toEqual(0.05814850143495808);
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(743.3533003120947);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(1.0661971414805103);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(3492.473006786572);
...
it('middleware seek4 min pressure; alt start pt, opened constraints, feasible start; THICKNESS fixed', () => {
    ...
    expect(design.symbol_table[sto.RADIUS].name).toEqual("RADIUS");
    expect(design.symbol_table[sto.RADIUS].value).toEqual(0.7566964996102077);
    expect(design.symbol_table[sto.THICKNESS].name).toEqual("THICKNESS");
    expect(design.symbol_table[sto.THICKNESS].value).toEqual(0.045);
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(996.6773563197182);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(1.7988432573901598);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(4658.439766589454);
...
it('middleware seek5 max force; alt start pt, opened constraints, feasible start; no fixed', () => {
    ...
    expect(design.symbol_table[sto.RADIUS].name).toEqual("RADIUS");
    expect(design.symbol_table[sto.RADIUS].value).toEqual(0.757090147294469);
    expect(design.symbol_table[sto.THICKNESS].name).toEqual("THICKNESS");
    expect(design.symbol_table[sto.THICKNESS].value).toEqual(0.058360538073425804);
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(2713.8722061594754);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(1.8007153280793988);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(9775.5824538458);
...
//    store.dispatch(search());
    ...
    expect(design.symbol_table[sto.RADIUS].name).toEqual("RADIUS");
    expect(design.symbol_table[sto.RADIUS].value).toEqual(0.7529224268036674);
    expect(design.symbol_table[sto.THICKNESS].name).toEqual("THICKNESS");
    expect(design.symbol_table[sto.THICKNESS].value).toEqual(0.06530453483860871);
    expect(design.symbol_table[sto.FORCE].name).toEqual("FORCE");
    expect(design.symbol_table[sto.FORCE].value).toEqual(1104.699321666792);
    expect(design.symbol_table[sto.AREA].name).toEqual("AREA");
    expect(design.symbol_table[sto.AREA].value).toEqual(1.7809443105282723);
    expect(design.symbol_table[sto.STRESS].name).toEqual("STRESS");
    expect(design.symbol_table[sto.STRESS].value).toEqual(3575.778800340361);
