...
//    console.log('x=',x);
    ...
    expect(x[o.SI_Hi_Factor]).toEqual(45000);
    expect(x[o.End_Type]).toEqual(4);
    expect(x[o.End_ID]).toEqual(0);
    expect(x[o.Extended_End_ID]).toEqual(0);
    expect(x[o.L_End]).toEqual(0);
    expect(x[o.L_Extended_End]).toEqual(0);
    expect(x[o.Hook_Deflect_All]).toEqual(0.4);
    expect(x[o.Catalog_Name]).toEqual('');
    expect(x[o.Catalog_Number]).toEqual('');
    expect(x[o.tbase010]).toEqual(0.01);
...
//       0.0,           0.0,                 0.0, 'Extension', 1, 2, 'A228/QQW-470', 'Cold_Coiled', 'mat_us.json', 1,
