...
it('eqnset initialState', () => {
    ...
    // End_Geometry 40, Inactive_Coils 41, Grind_Amount 42, End_Reduction 43, Catalog_Name 44, Catalog_Number 45, tbase010 46, tbase400 47, const_term 48, slope_term 49,
       2,            2,                 1,               0,                   '',              '',                0.01,        0.4,         -2,            -106113.37959890341,
    // tensile_010 50
       370000];
//    console.log('p=',p);
//    console.log('x=',x);
