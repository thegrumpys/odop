...
it('eqnset with defaults', () => {
    ...
    p.push(10.0); // Force_1
    p.push(39.0); // Force_2
    x.push(0.0); // Mean_Dia 0 // x vector - to be filled in
...
//    console.log('x=',x);
    ...
    expect(x[o.Rate]).toEqual(22.631500235877994);
    expect(x[o.Deflect_1]).toEqual(0.44186200189004166);
    expect(x[o.Deflect_2]).toEqual(1.7232618073711625);
    expect(x[o.L_1]).toEqual(2.8081379981099586);
    expect(x[o.L_2]).toEqual(1.5267381926288375);
    expect(x[o.L_Stroke]).toEqual(1.281399805481121);
    ...
    expect(x[o.Spring_Index]).toEqual(9.426540275425081);
    expect(x[o.Force_Solid]).toEqual(49.6761430177522);
    expect(x[o.Stress_1]).toEqual(24893.492083880414);
    expect(x[o.Stress_2]).toEqual(97084.61912713361);
    expect(x[o.Stress_Solid]).toEqual(123661.26729701259);
    expect(x[o.FS_2]).toEqual(1.3463472671163415);
    expect(x[o.FS_Solid]).toEqual(1.056997186733545);
    expect(x[o.FS_CycleLife]).toEqual(1.3032218113738672);
    expect(x[o.Cycle_Life]).toEqual(1861894.9358992411);
    expect(x[o.PC_Avail_Deflect]).toEqual(78.50851058638553);
    expect(x[o.Energy]).toEqual(31.394295234287462);
    ...
    expect(x[o.Tensile]).toEqual(261419.22328169446);
    expect(x[o.PC_Tensile_Endur]).toEqual(50);
    expect(x[o.PC_Tensile_Stat]).toEqual(50);
    expect(x[o.Stress_Lim_Endur]).toEqual(130709.61164084723);
    expect(x[o.Stress_Lim_Stat]).toEqual(130709.61164084723);
