...
it('eqnset at valid min', () => {
    ...
    p.push(initialState.symbol_table[o.OD_Free].validmin+initialSystemControls.smallnum); // OD_Free // p vector
    p.push(initialState.symbol_table[o.Wire_Dia].validmin+initialSystemControls.smallnum); // Wire_Dia
    p.push(initialState.symbol_table[o.L_Free].validmin+initialSystemControls.smallnum); // L_Free
    p.push(initialState.symbol_table[o.Coils_T].validmin+initialSystemControls.smallnum); // Coils_T
    p.push(initialState.symbol_table[o.Force_1].validmin+initialSystemControls.smallnum); // Force_1
    p.push(initialState.symbol_table[o.Force_2].validmin+initialSystemControls.smallnum); // Force_2
    x.push(0.0); // Mean_Dia 0 // x vector - to be filled in by eqnset
    x.push(0.0); // Coils_A 1
    x.push(0.0); // Rate 2
    x.push(0.0); // Deflect_1 3
...
//    console.log('x=',x);
    ...
    expect(p[o.OD_Free]).toEqual(initialState.symbol_table[o.OD_Free].validmin+initialSystemControls.smallnum);
    expect(p[o.Wire_Dia]).toEqual(initialState.symbol_table[o.Wire_Dia].validmin+initialSystemControls.smallnum);
    expect(p[o.L_Free]).toEqual(initialState.symbol_table[o.L_Free].validmin+initialSystemControls.smallnum);
    expect(p[o.Coils_T]).toEqual(initialState.symbol_table[o.Coils_T].validmin+initialSystemControls.smallnum);
    expect(p[o.Force_1]).toEqual(initialState.symbol_table[o.Force_1].validmin+initialSystemControls.smallnum);
    expect(p[o.Force_2]).toEqual(initialState.symbol_table[o.Force_2].validmin+initialSystemControls.smallnum);
    expect(x[o.Mean_Dia]).toEqual(-1e+32);
    expect(x[o.Coils_A]).toEqual(-1e+32);
//    expect(x[o.Rate]).toEqual(22.631500150071364);
//    expect(x[o.Deflect_1]).toEqual(0.4418620035653477);
//    expect(x[o.Deflect_2]).toEqual(1.723261813904856);
//    expect(x[o.L_1]).toEqual(2.8081379964346525);
...
//    expect(x[o.tensile_010]).toEqual(370000);
    ...
    expect(p[o.OD_Free]).toBeGreaterThan(initialState.symbol_table[o.OD_Free].validmin);
    expect(p[o.Wire_Dia]).toBeGreaterThan(initialState.symbol_table[o.Wire_Dia].validmin);
    expect(p[o.L_Free]).toBeGreaterThan(initialState.symbol_table[o.L_Free].validmin);
    expect(p[o.Coils_T]).toBeGreaterThan(initialState.symbol_table[o.Coils_T].validmin);
    expect(p[o.Force_1]).toBeGreaterThan(initialState.symbol_table[o.Force_1].validmin);
    expect(p[o.Force_2]).toBeGreaterThan(initialState.symbol_table[o.Force_2].validmin);

    expect(p[o.OD_Free]).toBeLessThanOrEqual(initialState.symbol_table[o.OD_Free].validmax);
    expect(p[o.Wire_Dia]).toBeLessThanOrEqual(initialState.symbol_table[o.Wire_Dia].validmax);
    expect(p[o.L_Free]).toBeLessThanOrEqual(initialState.symbol_table[o.L_Free].validmax);
    expect(p[o.Coils_T]).toBeLessThanOrEqual(initialState.symbol_table[o.Coils_T].validmax);
    expect(p[o.Force_1]).toBeLessThanOrEqual(initialState.symbol_table[o.Force_1].validmax);
    expect(p[o.Force_2]).toBeLessThanOrEqual(initialState.symbol_table[o.Force_2].validmax);
});