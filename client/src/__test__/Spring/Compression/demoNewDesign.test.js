...
it('demoNewDesign', () => {
    ...
    // title: "Page 02 of 14",
    store.dispatch(loadInitialState('Spring/Compression'));
    ...
    store.dispatch(changeSymbolConstraint('FS_CycleLife', MIN, 1.0));
    ...
    store.dispatch(changeSymbolConstraint('L_Solid', MAX, 1.30));
    store.dispatch(setSymbolFlag('L_Stroke', MIN, CONSTRAINED));
    store.dispatch(changeSymbolConstraint('L_Stroke', MIN, 0.65));
    store.dispatch(fixSymbolValue('Force_1', 30.0));
    store.dispatch(fixSymbolValue('Force_2', 60.0));
    ...
    // title: "Page 10 of 14",
    store.dispatch(fixSymbolValue("Wire_Dia",0.135)); // Simulate Action: Select Size...
