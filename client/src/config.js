...
//  console.log('In config process.env.REACT_APP_SESSION_REFRESH=', process.env.REACT_APP_SESSION_REFRESH);
  ...
  env_types = process.env.REACT_APP_DESIGN_TYPES || '["Hookes-Law/Compression","Hookes-Law/Extension","Hookes-Law/Torsion","Piston-Cylinder","Solid","Spring/Compression","Spring/Extension","Spring/Torsion"]';
...
//  console.log('In config env.REACT_APP_SESSION_REFRESH=', env.REACT_APP_SESSION_REFRESH);
  ...
  env_types =  env.REACT_APP_DESIGN_TYPES || '["Hookes-Law/Compression","Hookes-Law/Extension","Hookes-Law/Torsion","Piston-Cylinder","Solid","Spring/Compression","Spring/Extension","Spring/Torsion"]';
  env_types = JSON.parse(env_types);
